...
export const metadata: Metadata = {
  ...
  description: "A premium countryside destination for nature-led stays, day outings, family time and unforgettable gatherings.",
  openGraph: {
    title: "DS Agro Tourism & Resort",
    description: "From city noise to natural luxury.",
    type: "website",
    url: siteUrl,
    images: [previewImage],
  },
